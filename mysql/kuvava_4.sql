...
CREATE TABLE `koment` (
  ...
  `stranka_number2` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `odkaz` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `href` varchar(255) COLLATE utf8_czech_ci NOT NULL,
  `title_attr` varchar(255) COLLATE utf8_czech_ci DEFAULT NULL,
  `text` varchar(255) COLLATE utf8_czech_ci NOT NULL,
  `target` char(1) COLLATE utf8_czech_ci NOT NULL DEFAULT 's',
  `nofollow` smallint(6) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
...
CREATE TABLE `stranka` (
  ...
  `view` varchar(100) COLLATE utf8_czech_ci NOT NULL DEFAULT 'default',
  ...
  `title_facebook` varchar(100) COLLATE utf8_czech_ci NOT NULL,
  `description` varchar(200) COLLATE utf8_czech_ci NOT NULL,
  `h1` varchar(100) COLLATE utf8_czech_ci NOT NULL,
...
INSERT INTO `stranka` (`id`, `presenter`, `view`, `url1`, `url2`, `number1`, `title_tag`, `title_facebook`, `description`, `h1`, `content`, `vizte_tez`, `diskuze`, `sdilet`, `clanek`, `archiv`, `submenu`, `actmenu`) VALUES
(1,	'Www',	'default',	'',	'',	0,	'Jana Urbanová a Tomáš Urban Vás vítají',	'Vítejte na webu o lidech, pohodě a léčitelství',	'Jana a Tomáš Urbanovi se věnují například léčitelství, poradenství, věštectví nebo umění. Něco dělají zdarma, něco za peníze.',	'Vítejte na webu o lidech, pohodě a léčitelství<br>(www.kuvava.cz)',	'<p>Jsme Jana a Tomáš Urbanovi. Věnujeme se například umění, alternativní medicíně a poradenství. Především však rozvíjíme spokojenost. Něco děláme zdarma, něco za peníze...</p>\r\n<h2>Naše kontaktní údaje</h2>\r\n<dl>\r\n<dt>Telefon:</dt>\r\n<dd><strong>00420 / 777 790 528</strong></dd>\r\n<dt>Email:</dt>\r\n<dd><a href=\"mailto:urbanovi@kuvava.cz\">urbanovi@<!-- -->kuvava.cz</a></dd>\r\n<dt>České číslo účtu:</dt>\r\n<dd><strong>107-3720830217 /&nbsp;0100</strong> (u&nbsp;Komerční banky)<br><small>(Pokud uvedete jako variabilní symbol své mobilní telefonní číslo, zašleme Vám smskou potvrzení, že jsme platbu zdárně obdrželi.)</small></dd>\r\n<dt>Slovenské číslo účtu:</dt>\r\n<dd>18561447 / 6500 (u Poštové banky)</dd>\r\n</dl>',	'<p><a href=\"/\">Velmi zajímavý článek k věci</a></p>\r\n<p><a href=\"/\">Související služba s tematickým popiskem</a></p>\r\n<p><a href=\"/\">Další související služba</a></p>',	1,	1,	0,	0,	NULL,	'm1c1'),
(2,	'Diskuze',	'puvodniZneni',	'',	'',	0,	'Vzájemné rozhovory komunity kolem www.kuvava.cz',	'',	'Diskuze o lidech, pohodě a léčitelství... I na jiná témata. Účastní se i autoři webu: Jana Urbanová a Tomáš Urban',	'',	'',	NULL,	2,	1,	0,	0,	NULL,	'm2c3');
